...
@section('title', 'Jadwal Pengajian Shubuh')

@section('content_header')
    <h1>Jadwal Pengajian Shubuh</h1>
@stop
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header bg-info">
                    <div class="card-title">Jadwal Pengajian Shubuh</div>
                </div>
                <div class="card-body">
        ...
        <div class="modal-content">
            ...
            <form id="formAddData">
                <div class="modal-body">
                    @csrf
                    <input type="hidden" name="pengajian" id="pengajian" value="shubuh" required>
...
<script>
    $( document ).ready(function() {
        var table = $('#dataTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url:  "{{route('jadwal.pengajian-shubuh')}}",
                type: 'GET',
            },
            columns: [
