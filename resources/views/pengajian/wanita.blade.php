...
@section('title', 'Jadwal Pengajian Wanita')

@section('content_header')
    <h1>Jadwal Pengajian Wanita</h1>
@stop
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header bg-primary">
                    <div class="card-title">Jadwal Pengajian Wanita</div>
                </div>
                <div class="card-body">
        ...
        <div class="modal-content">
            ...
            <form id="formAddData">
                <div class="modal-body">
                    @csrf
                    <input type="hidden" name="pengajian" id="pengajian" value="wanita" required>
...
<script>
    $( document ).ready(function() {
        var table = $('#dataTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url:  "{{route('jadwal.pengajian-wanita')}}",
                type: 'GET',
            },
            columns: [
